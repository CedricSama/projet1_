;(function ($, window, document, undefined) {
    ...
    let pluginName = 'stellar',
        ...
        scrollProperty = {
            ...
            transform: {
                getLeft: function ($elem) {
                    let computedTransform = getComputedStyle($elem[0])[prefixedTransform];
        ...
        vendorPrefix = (function () {
            let prefixes = /^(Moz|Webkit|Khtml|O|ms|Icab)(?=[A-Z])/,
    ...
    Plugin.prototype = {
        ...
        refresh: function (options) {
            ...
            if (options && options.firstLoad && /WebKit/.test(navigator.userAgent)) {
                $(window).load(function () {
                    let oldLeft = self._getScrollLeft(),
                        oldTop = self._getScrollTop();
        ...
        _detectViewport: function () {
            let viewportOffsets = this.$viewportElement.offset(),
        ...
        _repositionElements: function () {
            let scrollLeft = this._getScrollLeft(),
                scrollTop = this._getScrollTop(),
                horizontalOffset,
                verticalOffset,
                particle,
